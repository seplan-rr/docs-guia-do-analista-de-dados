...
- [Extração](./conceitos/extracao.md)
  ...
  - [Arquivos Estruturados]()
    ...
    - [JSON](./conceitos/extracao/arquivos-estruturados/json.md)
...
- [Extração](./guia-de-referencia/extracao.md)
    - [JSON](./guia-de-referencia/extracao/json.md)
    - [XML](./guia-de-referencia/extracao/xml.md)
    - [API Pública]()
    - [Bases de Dados]()
...
- [Transformação](./guia-de-referencia/transformacao.md)
- [Carregamento]()
  - [Batch ou Streaming]()
